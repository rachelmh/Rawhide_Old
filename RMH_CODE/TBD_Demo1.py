...
def main():
	...
	poirot=RobotArm_TBD('tcp://localhost:46185/SawyerRMHServer/Sawyer')
	captain=RobotArm_TBD('tcp://localhost:45981/SawyerRMHServer/Sawyer')
	...
	#DA_Move_To_Position(poirot,captain,[0, 0, 0, 2.2, 0, -.5, 3.3],[0, 0, 0, 2.2, 0,-.5,3.3])
	...
	while not rospy.is_shutdown():
		...
		if done_recording_flag==1:
			if playback_flag==0:
					...
					if button == 'x':
						print('playback here!')
						playback(robot1,robot2,filename_list)
						time.sleep(2)
