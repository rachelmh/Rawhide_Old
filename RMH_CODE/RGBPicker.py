...
if masking:
    while True:
        ...
        #cv2.putText(imageOut, 'hi', (10,10), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255), lineType=cv2.LINE_AA)
        #cv2.imshow('RGB', imageOut)
...
if tracking:
    ...
    while True:
        ...
        # color space
        image = imutils.resize(image, width=800, height=1000)
        ...
        #cv2.putText(image, 'blue', (100,500), cv2.FONT_HERSHEY_SIMPLEX, 5.0, (255, 255, 255),thickness=10, lineType=cv2.LINE_AA)
