...
def playback(robot1,robot2,filename_list):
	for fn in filename_list:
		...
		for goal in jointgoal:
			...
			robot1.Set_Position( goal[1:8],1)
			robot2.Set_Position( goal[8:15],1)
...
def main():
	...
	poirot=RobotArm_TBD('tcp://localhost:45285/SawyerRMHServer/Sawyer')
	captain=RobotArm_TBD('tcp://localhost:46241/SawyerRMHServer/Sawyer')
	...
	DA_Move_To_Position(poirot,captain,[0, -1, 0, 2.5, 0, -1.5, 0],[0, -1, 0, 2.5, 0,-1.5, 0])
	time.sleep(1)
